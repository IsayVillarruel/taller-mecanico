...
<?php $name_interno = "Nueva entrada de trabajo"; ?>
    ...
    <div class="container-fluid">
        <div class="col">
            <div class="card">
                ...
                <form action="{{ URL::to("admin/".$sNameModule."/add") }}" method="post" id="form-control" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md">
                                <div class="form-group">
                                    ...
                                    <input value="" type="text" class="form-control" id="customer_name" name="customer_name" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md">
                                <div class="form-group">
                                    ...
                                    <input value="" type="text" class="form-control" id="customer_number" name="customer_number" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md">
                                <div class="form-group">
                                    ...
                                    <input value="" type="text" class="form-control" id="customer_email" name="customer_email" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md">
                                ...
                                <select class="form-control" name="car_id" value="" require>
                                    ...
                                    @foreach ($oCar as $car)
                                        <option value="{{ $car->id }}" required>{{ $car->brand.' - '.$car->version }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-sm-12 col-md">
                                <div class="form-group">
                                    ...
                                    <input value="" type="text" class="form-control" id="car_model" name="car_model" required>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md">
                                <div class="form-group">
                                    ...
                                    <input value="" type="text" class="form-control" id="car_plates" name="car_plates" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md">
                                <div class="form-group">
                                    ...
                                    <textarea type="textarea" class="form-control" name="failures" id="failures"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ml-4">
                            <div class="row">
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Herramientas y Gato]" id="herramientas">
                                ...
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Llanta de refacción]" id="llanta_refaccion">
                                ...
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Radio]" id="radio">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Tapetes]" id="tapetes">
                                ...
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Limpiadores]" id="limpiadores">
                                ...
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Encendedor]" id="encendedor">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Extinguidor]" id="extinguidor">
                                ...
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Antena]" id="antena">
                                ...
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Tapones Rueda]" id="tapones_rueda">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Tapon Combustible]" id="tapon_combustible">
                                ...
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Faros]" id="faros">
                                ...
                                <div class="col-sm-12 col-md">
                                    <div class="form-group">
                                        <input type="checkbox" class="form-check-input" name="check_in[Espejos]" id="espejos">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 5%">
                                                <button type="button" class="btn btn-sm btn-primary" onclick="addDamage()"><i class="fas fa-plus-square"></i>Agregar</button>
                                            </th>
                                        </tr>
                                    </thead>
...
<script>
    $(function(){
        ...
        function addDamage(){
            ...
            <td>
                <input type="file" class="form-control" id="damage_picture" name="car_parts[][image]" accept="image/*;capture=camera" capture="environment" required>
            </td>
            <td>
