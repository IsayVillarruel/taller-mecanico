...
<?php $name_interno = "Edición de Servicios"; ?>
...
@section("breadcrumb")
	...
	<ol class="breadcrumb float-sm-right">
		...
		<li class="breadcrumb-item"><a href="{{ URL::to("admin/".$sNameModule."/index") }}">Servicios</a></li>
		<li class="breadcrumb-item active">Editando - {{ $oService->name }}</li>
	</ol>
	...
	<div class="container-fluid">
		<div class="col">
			<div class="card">
	            ...
	            <form action="{{ URL::to("admin/".$sNameModule."/edit/".$oService->id) }}" method="post" id="form-control">
	            	@csrf
	            	<div class="card-body" >
	            		<div class="row">
	            			<div class="col-sm-12 col-md">
	            				<div class="form-group">
				                	...
				                	<input type="text" class="form-control" id="name" name="name" value="{{ $oService->name }}" required>
				                </div>
	            			</div>
	            			...
	            			<div class="col-sm-12 col-md">
	            				<div class="form-group">
				                	...
				                	<input type="text" class="form-control" id="description" name="description" value="{{ $oService->description }}" required>
				                </div>
	            			</div>
                            ...
                            <input type="text" name="id" value="{{ $oService->id }}" hidden>
	            		</div>
		            </div>
