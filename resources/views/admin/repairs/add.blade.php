...
<?php $name_interno = "Nuevo Servicio"; ?>
...
@section("breadcrumb")
	...
	<ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="{{ URL::to("admin/job-entrys/workshop/{$oJob->id}") }}">{{ $oJob->Car->brand." ".$oJob->Car->version." - ".$oJob->car_plates }}</a></li>
    ...
    <div class="container-fluid">
        <div class="col">
            <div class="card">
                ...
                <form action="{{ URL::to("admin/job-entrys/{$oJob->id}/{$sNameModule}/add") }}" method="post" id="form-control" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-sm-12 col-md">
                                ...
                                <select class="form-control" name="service_id" value="" require>
                                    ...
                                    @foreach ($oServices as $service)
                                        <option value="{{ $service->id }}" required>{{ $service->name.' - '.$service->description }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="change_parts" id="change_parts" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="new_parts" id="new_parts" class="form-control" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-6 offset-6 text-right">
                                ...
                                <button type="button" class="btn btn-primary btn-cancel-button-redirect" data-url="{{ URL::to("admin/job-entrys/workshop/".$oJob->id."") }}">Cancelar</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        $("#form-control").submit(function(event)
          {
            ...
            $.ajax({
              ...
              if(data.error=="success")
              {
                ...
                setTimeout(function(){
                  document.location="{{ URL::to("admin/job-entrys/workshop/{$oJob->id}") }}";
                }, 1000);
